...
//    @Override
    public void addFieldComment(Field field, IntrospectedTable introspectedTable,
        ...
        apiSb.append("@ApiModelProperty(value = \"");
        apiSb.append(introspectedColumn.getRemarks());
        apiSb.append("\", name = \"");
        apiSb.append(field.getName());
        apiSb.append("\")");
        field.addJavaDocLine(apiSb.toString());
        if(field.getName().equals("id")){
            StringBuilder sbId = new StringBuilder();
            sbId.append("@TableId(value=\"id\",type = IdType.AUTO)");
            field.addJavaDocLine(sbId.toString());
        }
